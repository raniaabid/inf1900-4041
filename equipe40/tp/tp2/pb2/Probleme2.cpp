...
void stateAction(State& state, bool& isStateChange, int counter){
...
int main(){
    ...
    uint8_t previousState = BUTTON_UNPRESSED;
    ...
    for(;;++amberColorFrameCounter){
        ...
        stateAction(state, isStateChange, amberColorFrameCounter);
